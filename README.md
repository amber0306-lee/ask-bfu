...
> 独立社区项目，非北京林业大学官方服务。v0.3.1 聚焦经济管理学院；涉及个人毕业或发放资格以其年级适用的正式文件和审核为准。
...
| [source-index.md](skills/ask-bfu/references/source-index.md) | 25项校院公开文件入口、发布日期和适用范围 |
...
| [tests/qa-runs.md](tests/qa-runs.md) | 七轮共70道人工模拟提问及来源对应 |
| [tests/personas.md](tests/personas.md) | 5个人设×3问的场景问答测试及覆盖结论 |
...
按入学、课程、奖助、研究成果、毕业阶段各抽10题，覆盖本科、硕士、博士，v0.2.1 加10题补测新增资助事实，v0.3.0 加10题补测出国交换模块；[查看完整题目与期望答案](tests/qa-runs.md)。70题均可在已收录事实卡定位并追到官方原件。此结果是人工资料检索与索引核查，尚未在已安装的 Codex 中跑端到端问答。
...
Install the entire [skill directory](skills/ask-bfu/) in an Agent Skills compatible Codex environment. The repository links to public university PDFs; it does not currently mirror their binary contents. The [70-question manual source audit](tests/qa-runs.md) documents coverage and remaining gaps.

---

[MIT License](LICENSE) · v0.3.1
